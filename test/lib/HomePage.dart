            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Image.asset(
                  'assets/1.png', width: double.infinity, fit: BoxFit.cover ),
      ...
      children: [
       Card(
        child: Column(
          ...
          children: [
            Image.asset('assets/2.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
    ...
    return ListView(
      ...
      children: [
       Card(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/3.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      Card(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/4.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/5.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return ListView(
      ...
      children: [
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/6.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      Card(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/7.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return ListView(
      ...
      children: [
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Image.asset('assets/8.png', width: double.infinity, fit: BoxFit.cover), // Hình ảnh ở đầu
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
